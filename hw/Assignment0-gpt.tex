...
\begin{solution}
  a) $5^3=125$\\b) $2^3\cdot 2^2=2^5=32$\\c) $\frac{3^6}{3^3}=3^3=27$\\d) $5^0=1$\\e) $(2^4)^2=2^8=256$\\f) $2^{(4^2)}=2^{16}=65536$\\g) $16^{\frac 12}=4$\\h) $16^{-2}=\frac{1}{16^2}=\frac{1}{256}$
\end{solution}
...
\begin{solution}
  a) $\log_2{64}=6$\\b) $\log_7{7}=1$\\c) $\log_7{1}=0$\\d) $\log_7{0}=\textit{undefined}$\\e) $\log_5(x+y)=\log_5(x)+\log_5(y)=2.6+5.2=7.8$\\f) $\log_5(xy)=\log_5(x)+\log_5(y)=2.6+5.2=7.8$\\g) $\log_2(x)=\frac{\log_5(x)}{\log_5(2)}=\frac{2.6}{\log_5(2)}$\\h) $\log_5(x^{25})=25\log_5(x)=25\cdot2.6=65$
\end{solution}
