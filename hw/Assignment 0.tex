...
\begin{solution}
I like CLCIV 382 the most because it is a class classified by r/uofm Reddit as a class where you do a "whole lotta nothing".
\end{solution}
...
\begin{solution}
    Lecture slides, lecture recordings, course announcements: Canvas/files
    Scheduled office hours: Canvas (Google calendar)
    Questions and answers about course content and logistics (online forum): Piazza
\end{solution}
