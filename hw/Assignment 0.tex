...
\begin{solution}
  a) $\log_2{64}=6$\\b) $\log_7{7}=1$\\c) $\log_7{1}=0$\\d) $\log_5(x)=2.6 x=65.66 \log_5(y)=5.2 y=4311.66 \log_5(x+y)=5.21$ or we can say $\log_5(y)$ is much bigger thus $\log_5(x+y)$ is pretty close to $\log_5(y)$\\ f) $\log_5(xy)=\log_5(x)+\log_5(y)=2.6+5.2=7.8$\\g) $\log_2(x)=\log_2(65.66)=6.0$ \\h) $\log_5(x^{25})=25\cdot \log_5(x^{25})=25\cdot 2.6=65$
\end{solution}
