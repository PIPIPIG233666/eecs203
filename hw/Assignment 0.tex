...
\begin{solution}
  ...
  \\c) $\log_7{1}=0$
  \\d) $\log_7{0}=$undefined
  \\e) if we can use a calculator, then$\log_5(x)=2.6\;x=65.66\;\log_5(y)=5.2\;y=4311.66\;\log_5(x+y)=5.21$ or we can say $\log_5(y)$ is much bigger than $\log_5(x)$ thus $\log_5(x+y)$ is pretty close to $\log_5(y)$ which is 5.2, or it is too hard to compute.
